...
function writeASBFData(N)
  ...
  writeFloatMatrix(fid, Rquad, 'ASBF DISCRETE QUADRATURE NODES');
  writeFloatMatrix(fid, Wquad, 'ASBF DISCRETE QUADRATURE WEIGHTS');
  writeFloatMatrix(fid, Rgll,  'ASBF DISCRETE GLL NODES');
  writeFloatMatrix(fid, Rplot, 'ASBF DISCRETE PLOT NODES');
  ...
  writeFloatMatrix(fid, VTquad,  'ASBF DISCRETE INITIAL BASIS DIRICHLET-DIRICHLET QUADRATURE VANDERMONDE');
  writeFloatMatrix(fid, VDTquad, 'ASBF DISCRETE INITIAL BASIS DIRICHLET-DIRICHLET QUADRATURE DERIVATIVE VANDERMONDE');
  writeFloatMatrix(fid, VTgll,   'ASBF DISCRETE INITIAL BASIS DIRICHLET-DIRICHLET GLL VANDERMONDE');
  writeFloatMatrix(fid, VDTgll,  'ASBF DISCRETE INITIAL BASIS DIRICHLET-DIRICHLET GLL DERIVATIVE VANDERMONDE');
  writeFloatMatrix(fid, VTplot,  'ASBF DISCRETE INITIAL BASIS DIRICHLET-DIRICHLET PLOT VANDERMONDE');
  writeFloatMatrix(fid, VDTplot, 'ASBF DISCRETE INITIAL BASIS DIRICHLET-DIRICHLET PLOT DERIVATIVE VANDERMONDE');
  ...
  writeFloatMatrix(fid, VTquad,  'ASBF DISCRETE INITIAL BASIS NEUMANN-NEUMANN QUADRATURE VANDERMONDE');
  writeFloatMatrix(fid, VDTquad, 'ASBF DISCRETE INITIAL BASIS NEUMANN-NEUMANN QUADRATURE DERIVATIVE VANDERMONDE');
  writeFloatMatrix(fid, VTgll,   'ASBF DISCRETE INITIAL BASIS NEUMANN-NEUMANN GLL VANDERMONDE');
  writeFloatMatrix(fid, VDTgll,  'ASBF DISCRETE INITIAL BASIS NEUMANN-NEUMANN GLL DERIVATIVE VANDERMONDE');
  writeFloatMatrix(fid, VTplot,  'ASBF DISCRETE INITIAL BASIS NEUMANN-NEUMANN PLOT VANDERMONDE');
  writeFloatMatrix(fid, VDTplot, 'ASBF DISCRETE INITIAL BASIS NEUMANN-NEUMANN PLOT DERIVATIVE VANDERMONDE');
